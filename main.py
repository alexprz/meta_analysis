...
if __name__ == '__main__':
    ...
    sigma = 2.
    img, n_peaks = am.build_activity_map_from_keyword(keyword, sigma=sigma, gray_matter_mask=True)
    ...
    am.plot_activity_map(img, glass_brain=False, threshold=threshold)
